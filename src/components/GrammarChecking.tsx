...
const grammarOptions = ['Check Grammar']

interface GrammarCheckingProps {
  onOptionSelect: (option: string) => void
  selectedOption: string | null
  onReset: () => void
}

export function GrammarChecking({ onOptionSelect, selectedOption, onReset }: GrammarCheckingProps) {
  return (
    <div className="bg-white shadow-sm rounded-lg p-6 dark:bg-gray-800">
      <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Grammar Checking</h2>

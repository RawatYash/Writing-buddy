...
const tableOperationOptions = ['Table Summarization', 'Table Conclusion']
...
export function TableOperations({ onOptionSelect, selectedOption, onReset }: TableOperationsProps) {
  return (
    <div className="bg-white shadow-sm rounded-lg p-6 dark:bg-gray-800">
      <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Table Operations</h2>
      <div className="flex flex-wrap gap-4 mb-6">
        {tableOperationOptions.map((option) => (
          <button
            key={option}

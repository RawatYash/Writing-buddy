...
const textComparisonOptions = ['Text Difference']
...
export function TextComparison({ onOptionSelect, selectedOption, onReset }: TextComparisonProps) {
  return (
    <div className="bg-white shadow-sm rounded-lg p-6 dark:bg-gray-800">
      <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Text Comparison</h2>
      <div className="flex flex-wrap gap-4 mb-6">
        {textComparisonOptions.map((option) => (
          <button
            key={option}

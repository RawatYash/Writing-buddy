...
const contentGenerationOptions = ['Summarization', 'List Expansion', 'Conclusion Generation']
...
export function ContentGeneration({ onOptionSelect, selectedOption, onReset }: ContentGenerationProps) {
  return (
    <div className="bg-white shadow-sm rounded-lg p-6 dark:bg-gray-800">
      <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Content Generation</h2>

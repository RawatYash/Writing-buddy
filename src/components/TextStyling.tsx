...
const textStylingOptions = ['Style Text']
...
export function TextStyling({ onOptionSelect, selectedOption, onReset }: TextStylingProps) {
  return (
    <div className="bg-white shadow-sm rounded-lg p-6 dark:bg-gray-800">
      <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Text Styling</h2>
      <div className="flex flex-wrap gap-4 mb-6">
        {textStylingOptions.map((option) => (
          <button
            key={option}
